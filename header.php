...
<head>
	...
	<?php if ( ! has_site_icon() ) : ?>
		<link rel="icon" href="<?php echo esc_url( AIRE_URI . '/assets/img/favicon.ico' ); ?>" sizes="any" />
		<link rel="icon" type="image/png" href="<?php echo esc_url( AIRE_URI . '/assets/img/favicon-512.png' ); ?>" sizes="512x512" />
		<link rel="apple-touch-icon" href="<?php echo esc_url( AIRE_URI . '/assets/img/favicon-512.png' ); ?>" />
	<?php endif; ?>
	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
